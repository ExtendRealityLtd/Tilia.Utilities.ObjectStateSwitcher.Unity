...
The `Utilities.ObjectStateSwitcher` prefab provides the ability to specify a collection of [Unity] GameObjects and decide the target active state via a visual screen user interface. This prefab can be included in a Unity software project via the [Unity Package Manager].
...
* Adjust the [project manifest file][Project-Manifest] `manifest.json` in a text editor.
  ...
  * Add `io.extendreality.tilia.utilities.objectstateswitcher.unity` to `dependencies`, stating the latest version.
  ...
  ```json
  {
    ...
    "dependencies": {
      "io.extendreality.tilia.utilities.objectstateswitcher.unity": "X.Y.Z",
      ...
    }
  }
  ```
...
The `Tilia Utilities ObjectStateSwitcher Unity` package will now be available in your Unity project `Packages` directory ready for use in your project.
